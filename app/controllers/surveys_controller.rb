class SurveysController < ApplicationController
  ...
  def create
    ...
    if (@survey && @response_set)
      ...
      flash[:notice] = t('surveys.Unable_to_find_that_survey')
  ...
  def show
    ...
    if @response_set
      ...
      flash[:notice] = t('surveys.unable_to_find_your_responses')
      redirect_to surveyor_index
    end
  end
  ...
  def update
    ...
    return redirect_with_message(surveyor_finish, :notice, t('surveys.completed_survey')) if saved && params[:finish]

    respond_to do |format|
      format.html do
        if @response_set.nil?
          return redirect_with_message(available_surveys_path, :notice, t('surveys.unable_to_find_your_responses'))
        else
          flash[:notice] = t('surveys.unable_to_update_survey') unless saved
